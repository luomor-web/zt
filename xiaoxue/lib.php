...
/* 英语四线三格 CSS（用边框画线，打印不依赖背景图形设置；第三线加粗为书写基线，行间留白） */
function xx_eng_css(){
	return <<<CSS
...
.eng-grid::after{ content:""; position:absolute; left:0; right:0; top:62px; border-top:2px solid #999; }
.eng-grid + .eng-grid, .eng-zh + .eng-grid{ margin-top:16px; }
